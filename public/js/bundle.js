...
var app = (function (exports) {
    ...
    const file$2 = "src\\components\\test.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			img = element("img");
    			this.c = noop;
    			add_location(h1, file$2, 7, 2, 93);
    			add_location(p, file$2, 8, 2, 132);
    			if (img.src !== (img_src_value = "../resources/img/logo.png")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			add_location(img, file$2, 9, 2, 149);
    ...
    const file$1 = "src\\components\\material.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			this.c = noop;
    			add_location(h3, file$1, 2, 0, 40);
    			add_location(child_ui, file$1, 3, 0, 56);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
